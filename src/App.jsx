...
// 2. Importaciones de los estilos de Swiper
import 'swiper/css';
...
import './assets/Cliente2.png'
import './assets/Cliente3.png'
import './assets/Cliente4.png'
import './assets/Cliente5.png'
      ...
      <section id="demo" className="py-20 bg-slate-800/50">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto mb-8">
                Te Invitamos a INTERACTURAR Con Nuestra TIENDA DEMO alli simulamos una tienda De Productos Varios, Recuerda que Nuestro  Sistema profesional de catálogo digital con pedidos a WhatsApp , ES TOTALMENTE ADAPTABLE A CUALQUIER TIPO DE PRODUCTO Y/ NEGOCIO.
            </p>
              ...
              <div className="bg-slate-800/80 backdrop-blur-sm border border-slate-700/50 rounded-xl p-6">
                ...
                >
                  <SwiperSlide>
                    <img 
                      src={adminPanel} 
                      alt="Panel Administrativo 1" 
                      className="w-full rounded-lg shadow-xl border border-slate-600/50"
                    />
                  </SwiperSlide>
                  {/* Agrega más imágenes aquí si quieres */}

                  <SwiperSlide>
                    <img 
                      src="/assets/7.png" // Ejemplo, usa otra imagen
                      alt="Panel Administrativo 3" 
                      className="w-full rounded-lg shadow-xl border border-slate-600/50"
                    />
                  </SwiperSlide>
                  ...
                  <SwiperSlide>
                    <img 
                      src="/assets/8.png" // Ejemplo, usa otra imagen
                      alt="Panel Administrativo 4" 
                      className="w-full rounded-lg shadow-xl border border-slate-600/50"
                    />
                  </SwiperSlide>
                  ...
                  <SwiperSlide>
                    <img 
                      src="/assets/9.png" // Ejemplo, usa otra imagen
                      alt="Panel Administrativo 5" 
                      className="w-full rounded-lg shadow-xl border border-slate-600/50"
                    />
                  </SwiperSlide>
                  ...
                  <SwiperSlide>
                    <img 
                      src="/assets/10.png" // Ejemplo, usa otra imagen
                      alt="Panel Administrativo 6" 
                      className="w-full rounded-lg shadow-xl border border-slate-600/50"
                    />
                  </SwiperSlide>
              ...
              <div className="bg-slate-800/80 backdrop-blur-sm border border-slate-700/50 rounded-xl p-6">
                ...
                >
                  <SwiperSlide>
                   ...
                   <SwiperSlide>
                    <img 
                      src="/assets/Cliente2.png" // Ejemplo, usa otra imagen
                      alt="Vista del Cliente 2" 
                      className="w-full rounded-lg shadow-xl border border-slate-600/50"
                    />
                  </SwiperSlide>
                  ...
                  <SwiperSlide>
                    <img 
                      src="/assets/Cliente3.png" // Ejemplo, usa otra imagen
                      alt="Vista del Cliente 3" 
                      className="w-full rounded-lg shadow-xl border border-slate-600/50"
                    />
                  </SwiperSlide>
                  ...
                  <SwiperSlide>
                    <img 
                      src="/assets/Cliente4.png" // Ejemplo, usa otra imagen
                      alt="Vista del Cliente 4" 
                      className="w-full rounded-lg shadow-xl border border-slate-600/50"
                    />
                  </SwiperSlide>
                  ...
                  <SwiperSlide>
                    <img 
                      src="/assets/Cliente5.png" // Ejemplo, usa otra imagen
                      alt="Vista del Cliente 5" 
                      className="w-full rounded-lg shadow-xl border border-slate-600/50"
                    />
                  </SwiperSlide>
